...
pFire_Neighbor = non_normalize_pFire_Neighbor / (non_normalize_pFire_Neighbor + non_normalize_pNotFire_Neighbor)
print(pFire_Neighbor)
pNotFire_Neighbor = non_normalize_pNotFire_Neighbor / (non_normalize_pFire_Neighbor + non_normalize_pNotFire_Neighbor)
